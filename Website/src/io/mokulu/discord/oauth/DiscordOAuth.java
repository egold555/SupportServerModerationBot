...
import static io.mokulu.discord.oauth.OAuthDiscordAPI.BASE_URI;
...
public class DiscordOAuth
{
    ...
    private static OAuthTokensResponse toObject(String str)
    {
        return gson.fromJson(str, OAuthTokensResponse.class);
    }
    ...
    public OAuthTokensResponse getTokens(String code) throws IOException
    {
    ...
    public OAuthTokensResponse refreshTokens(String refresh_token) throws IOException
    {
        Connection request = Jsoup.connect(BASE_URI + "/oauth2/token")
            .data("client_id", clientID)
            .data("client_secret", clientSecret)
