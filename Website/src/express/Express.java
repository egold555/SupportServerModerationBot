		...
		for (Object o : objects) {
			...
			for (Method method : methods) {
				...
				for (DynExpress dex : annotations) {
					...
					System.out.println("Adding '"+ method.getName() + "' in class '" + o.getClass().getSimpleName() + "' with route '" + context + "' with method '" + requestMethod + "'.");
					...
					//Make all routes also work with a trailing /
					// /api
					// /api/
					if(!context.equals("*")) {
